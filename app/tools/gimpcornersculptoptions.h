...
#define GIMP_CORNER_SCULPT_OPTIONS_CLASS(klass)    (G_TYPE_CHECK_CLASS_CAST ((klass), GIMP_TYPE_CORNER_SCULPT_OPTIONS, GimpCornerSculptOptionsClass))
#define GIMP_IS_CORNER_SCULPT_OPTIONS(obj)         (G_TYPE_CHECK_INSTANCE_TYPE ((obj), GIMP_TYPE_CORNER_SCULPT_OPTIONS))
